...
public class ImplLoginServiceLocator extends org.apache.axis.client.Service implements com.javaentrenamientos.ws.service.ImplLoginService {
    ...
    public com.javaentrenamientos.ws.service.ImplLogin getImplLogin() throws javax.xml.rpc.ServiceException {
    ...
    public com.javaentrenamientos.ws.service.ImplLogin getImplLogin(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.javaentrenamientos.ws.service.ImplLoginSoapBindingStub _stub = new com.javaentrenamientos.ws.service.ImplLoginSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.javaentrenamientos.ws.service.ImplLogin.class.isAssignableFrom(serviceEndpointInterface)) {
                com.javaentrenamientos.ws.service.ImplLoginSoapBindingStub _stub = new com.javaentrenamientos.ws.service.ImplLoginSoapBindingStub(new java.net.URL(ImplLogin_address), this);
                _stub.setPortName(getImplLoginWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.ws.javaentrenamientos.com", "ImplLoginService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.ws.javaentrenamientos.com", "ImplLogin"));
        }
